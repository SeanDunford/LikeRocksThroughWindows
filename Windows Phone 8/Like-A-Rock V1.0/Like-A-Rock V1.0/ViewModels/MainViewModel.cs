...
using Like_A_Rock_V1._0.Resources;
using System.Net;
using Like_A_Rock_V1._0.Views;
using Newtonsoft.Json;
using System.Collections.Generic;

namespace Like_A_Rock_V1._0.ViewModels
{
    public class MainViewModel : INotifyPropertyChanged
    {
        private List<SolImages> SolImagesList; 
        ...
        private void getSolList()
        {
            WebClient webClient = new WebClient();
            webClient.DownloadStringCompleted += new DownloadStringCompletedEventHandler(webClient_SolList);
            webClient.DownloadStringAsync(new Uri("http://mars.jpl.nasa.gov/msl-raw-images/image/image_manifest.json"));
        }
        ...
        {
            WebClient webClient = new WebClient();
            webClient.DownloadStringCompleted += new DownloadStringCompletedEventHandler(webClient_SolImages);
            webClient.DownloadStringAsync(new Uri(str));
        }
        void webClient_SolImages(object sender, DownloadStringCompletedEventArgs e)
        {
            asyncCounter--; 
